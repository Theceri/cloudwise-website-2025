...
export const metadata = {
  ...
  description:
    'Hands-on AI productivity training by Cloudwise. Two Saturday sessions every month (1st & 2nd Saturday, 9am–1pm), online or in Nairobi. Ksh 13,500 — includes the AI toolkit, session recordings & support community.',
  alternates: { canonical: '/ai-training' },
  openGraph: {
    title: 'Cloudwise AI Productivity Training — Work Smarter with AI',
    description:
      'Practical, hands-on AI training for you and your team. Every 1st & 2nd Saturday. Includes the AI toolkit, session recordings & support community.',
...
const VALUE_STACK = [
  ...
  { icon: PlayCircle, title: 'Session Recordings', desc: 'Every session recorded and shared — revisit any part, any time.', worth: 'Yours to keep' },
...
const FAQ_ITEMS = [
  ...
  { q: 'How much does it cost and what’s included?', a: 'Ksh 13,500 per person (introductory price; normally Ksh 30,000). It includes 8 hours of live training, an AI toolkit & prompt library, session recordings, and access to our WhatsApp support community.' },
      ...
      <section className="relative overflow-hidden border-t border-white/10 bg-ink py-24 md:py-32">
        ...
        <div className="container-px relative text-center">
          ...
          <Reveal as="p" delay={0.08} className="mx-auto mt-6 max-w-xl text-lg text-white/60">
            ...
            the toolkit, the recordings and the support community.
          </Reveal>
